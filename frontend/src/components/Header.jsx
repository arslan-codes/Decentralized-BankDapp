...
const Header = () => {
  return (
    <div className="flex justify-center">
      <div
        className="md: w-4/5   lg:  fixed top-2 z-50  m-2 p-1 bg-gradient-to-r from-pink-900 bg-opacity-30
        backdrop-blur-lg flex justify-center  rounded-full"
      >
        <div className="flex flex-row  gap-0    lg:flex-row md:gap-32">
          <RouterLink
            to="/"
            smooth={true}
            duration={500}
            className="btn btn-ghost text-sm text-white cursor-pointer md:text-lg"
          >
            <svg
